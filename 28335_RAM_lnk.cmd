...
PAGE 1 :
   ...
   RAML1      : origin = 0x00C000, length = 0x004000
   FLASHB      : origin = 0x330000, length = 0x008000     /* on-chip FLASH */
   EXTRAM	  : origin = 0x180000, length = 0x080000	/*Íâ²¿RAM*/
}
...
SECTIONS
{
   ...
   */
   ...
   DMARAML4         : > RAML1,     PAGE = 1
   DMARAML5         : > RAML1,     PAGE = 1
   DMARAML6         : > RAML1,     PAGE = 1
   DMARAML7         : > RAML1,     PAGE = 1
   ...
   .adc_cal     : load = ADC_CAL,   PAGE = 0, TYPE = NOLOAD
	...
	recData		: > EXTRAM	PAGE = 1
	result		: > EXTRAM	PAGE = 1
	validData	: > EXTRAM  PAGE = 1
